...
describe('WizardLanguageStep', () => {
  it('renders title and subtitle', () => {
    render(<WizardLanguageStep selectedLanguage="en" storedLanguage="en" onSelect={vi.fn()} />);
  ...
  it('puts stored language first when no detected language', () => {
    render(<WizardLanguageStep selectedLanguage="ca" storedLanguage="ca" onSelect={vi.fn()} />);
  ...
  it('marks selected language', () => {
    render(<WizardLanguageStep selectedLanguage="ca" storedLanguage="en" onSelect={vi.fn()} />);
  ...
  it('calls onSelect when a language is clicked', () => {
    ...
    render(<WizardLanguageStep selectedLanguage="en" storedLanguage="en" onSelect={onSelect} />);
